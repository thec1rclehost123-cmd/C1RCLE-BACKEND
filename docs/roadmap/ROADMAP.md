...
| 6 | Finance / Ledger / Payouts — settlement engine, bank accounts, disputes, T+3 batch | **in progress** (2026-09-07) — ledger, balances, payouts, bank accounts done + tested; checkout-webhook hookup blocked on a promoter-attribution design gap (userId vs organizationId), dispute + leaderboard not started. See phase file Session Log. | [phase-06-finance-ledger-payouts.md](phase-06-finance-ledger-payouts.md) |
