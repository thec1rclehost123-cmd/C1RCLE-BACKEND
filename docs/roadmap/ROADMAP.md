...
| 5 | Door / Scanner / Cover-wallet — entitlement scan + magic-ticket QR, walk-in/dine-in, cover-charge wallet | **in progress** (2026-08-20) — domain layer planned, HTTP wiring not started | [phase-05-door-scanner-cover-wallet.md](phase-05-door-scanner-cover-wallet.md) |
